...
namespace IMS.DAL.Maps.Recon {
    
    
    public class ViewUnloadsYyMmAllIDMap : ClassMap<ViewUnloadsYyMmAllID> {
        
        public ViewUnloadsYyMmAllIDMap() {
            Schema("recon");
			Table("view_unloads_yy_mm_all_id");
			...
			Map(x => x.unloads_n).Column("unloads_n");
